...
public class LocationUpdatesService extends Service {
    ...
    public void requestLocationUpdates() {
        ...
        startService(new Intent(getApplicationContext(), com.kamaii.rider.service.LocationUpdatesService.class));
        try {
    ...
    private Notification getNotification() {
        Intent intent = new Intent(this, com.kamaii.rider.service.LocationUpdatesService.class);
...
//                .setContentTitle(Utils.getLocationTitle(this))
    ...
    private void onNewLocation(Location location) {
        ...
        if (serviceIsRunningInForeground(this)) {
            ...
            updatelocationnew(userDTO.getUser_id(), "1", latitude + "", longitude + "");
        }
    }
    ...
    public class LocalBinder extends Binder {
        public com.kamaii.rider.service.LocationUpdatesService getService() {
            return com.kamaii.rider.service.LocationUpdatesService.this;
        }
    }
