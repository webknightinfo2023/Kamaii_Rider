package com.kamaii.rider.https;
...
import com.kamaii.rider.jsonparser.JSONParser;
...
public class HttpsRequest {
    ...
    public void stringPosttwo(final String TAG, final Helper h) {
        try {
    ...
    public void stringPostthree(final String TAG, final Helper h) {
        try {
            AndroidNetworking.post(Consts.BASE_URL3 + match)
                    .addBodyParameter(params)
                    .setTag("test")
                    .setPriority(Priority.HIGH)
                    .build()
    ...
    public void stringGettwo(final String TAG, final Helper h) {
        AndroidNetworking.get(Consts.BASE_URL2 + match)
                .setTag("test")
    ...
    public void imagePosttwo(final String TAG, final Helper h) {
        AndroidNetworking.upload(Consts.BASE_URL2 + match)
                .addMultipartFile(fileparams)
                .addMultipartParameter(params)
                .setTag("uploadTest")
                .setPriority(Priority.IMMEDIATE)
    ...
    public void imagePostthree(final String TAG, final Helper h) {
        AndroidNetworking.upload(Consts.BASE_URL3 + match)
                .addMultipartFile(fileparams)
                .addMultipartParameter(params)
                .setTag("uploadTest")
                .setPriority(Priority.IMMEDIATE)
