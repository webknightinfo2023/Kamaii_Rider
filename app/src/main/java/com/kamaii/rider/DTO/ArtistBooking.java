...
public class ArtistBooking implements Serializable {
    ...
    String partner_time_slot = "";
    String show_print_button = "";
    String customername = "";
    ...
    public String getShow_print_button() {
        return show_print_button;
    }

    public void setShow_print_button(String show_print_button) {
        this.show_print_button = show_print_button;
    }
    ...
    public String getPartner_time_slot() {
        return partner_time_slot;
    }

    public void setPartner_time_slot(String partner_time_slot) {
        this.partner_time_slot = partner_time_slot;
    }
    ...
    public String getMy_discount() {
        return my_discount;
    }

    public void setMy_discount(String my_discount) {
