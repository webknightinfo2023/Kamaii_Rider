...
public class SpinnerDialog {
    ...
    ArrayList<VehicleModel> VehicleModel;
    ...
    public SpinnerDialog(Activity activity, ArrayList<VehicleModel> categoryDTOS, String dialogTitle,int a) {
        this.VehicleModel = categoryDTOS;
        this.context = activity;
        this.dTitle = dialogTitle;
    }
...
/*
 public void showSpinerDialog2() {
        ...
        myAdapterRadio = new MyAdapterRadio(this.context, this.VehicleModel);
        listView.setAdapter(myAdapterRadio);
        adb.setView(v);
