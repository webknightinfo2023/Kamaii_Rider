...
public class ProjectUtils {
    ...
    public static boolean isTextValueFilled(TextView text) {
        if (text.getText() != null && text.getText().toString().trim().length() > 0 && text.getText().toString().equalsIgnoreCase("All Categories")) {
            return true;
        } else {
            return false;
        }
    }
    public static boolean isTextValueFilledsubcat(TextView text) {
        if (text.getText() != null && text.getText().toString().trim().length() > 0 && text.getText().toString().equalsIgnoreCase("All Sub Categories")) {
            return true;
        } else {
            return false;
        }
