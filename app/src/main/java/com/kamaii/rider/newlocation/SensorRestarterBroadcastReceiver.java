...
package com.kamaii.rider.newlocation;
...
public class SensorRestarterBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.i(com.kamaii.rider.newlocation.SensorRestarterBroadcastReceiver.class.getSimpleName(), "Service Stops! Oooooooooooooppppssssss!!!!");
