...
public class AdapterAllBookings extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    PrintInvoiceOrderDetails printInvoiceOrderDetails;

    public AdapterAllBookings(NewBookings newBookings, ArrayList<ArtistBooking> artistBookingsList, UserDTO userDTO, LayoutInflater myInflater,PrintInvoiceOrderDetails printInvoiceOrderDetails) {
        ...
        this.printInvoiceOrderDetails = printInvoiceOrderDetails;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holderMain, int pos) {
        ...
        if (holderMain instanceof MyViewHolder) {
            ...
            if (artistBookingsList.get(position).getShow_print_button().equalsIgnoreCase("1")){
                holder.binding.printbtn.setVisibility(View.VISIBLE);
            }else {
                holder.binding.printbtn.setVisibility(View.GONE);
            ...
            holder.binding.printbtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    printInvoiceOrderDetails.getInvoice(position);
                }
            });
